...
- Managed travel tool required: ${answers.travelManagedTool || 'Not specified'}
- Flag hotels booked outside tool: ${answers.travelFlagHotelsOutside || 'Not specified'}
- Flag flights booked outside tool: ${answers.travelFlagFlightsOutside || 'Not specified'}
...
Default review posture: ${answers.reviewAppetite === 'all' ? 'Review everything — human reviews all cases' :
  answers.reviewAppetite === 'tiered' ? 'Review by risk tier — auto-close low risk, human reviews medium and high' :
  answers.reviewAppetite === 'minimal' ? 'Minimal review — auto-close anything that doesn't meet a high bar' : 'Not specified'}
      ...
      <div style={styles.card}>
        ...
        {step === 'categories' && (
          <>
            <div style={styles.header}>
              ...
              <p style={styles.subtitle}>Section A: Which spend categories do your employees regularly use?</p>
            </div>
            <div style={styles.content}>
        ...
        {step === 'category-questions' && (
          <>
            <div style={styles.header}>
              <h2 style={styles.title}>Part 1: Audit Rules</h2>
              <p style={styles.subtitle}>Section B: Category-specific rules</p>
            </div>
            <div style={styles.content}>
              {selectedCategories.includes('travel') && (
                <div style={{ marginBottom: '40px', padding: '20px', background: '#f8fafc', borderRadius: '8px' }}>
                  ...
                  <QuestionInput label="Do you require travel to be booked through a managed travel tool?" id="travelManagedTool" answers={answers} handleAnswer={handleAnswer} type="yesno" />
                  <QuestionInput label="Flag hotels booked outside the tool?" id="travelFlagHotelsOutside" answers={answers} handleAnswer={handleAnswer} type="yesno" />
                  <QuestionInput label="Flag flights booked outside the tool?" id="travelFlagFlightsOutside" answers={answers} handleAnswer={handleAnswer} type="yesno" />
        ...
        {step === 'fraud' && (
          <>
            <div style={styles.header}>
              <h2 style={styles.title}>Part 1: Audit Rules</h2>
              <p style={styles.subtitle}>Section C: Fraud vectors</p>
            </div>
            <div style={styles.content}>
        ...
        {step === 'review-appetite' && (
          <>
            <div style={styles.header}>
              ...
              <p style={styles.subtitle}>Section A: Overall review appetite</p>
            </div>
            <div style={styles.content}>
              <div style={styles.question}>
                ...
                {[
                  ...
                  { value: 'minimal', label: 'Minimal review — auto-close anything that doesn't meet a high bar' }
                ].map(option => (
                  <div
                    key={option.value}
                    style={{
        ...
        {step === 'auto-close' && (
          <>
            <div style={styles.header}>
              <h2 style={styles.title}>Part 2: Review Instructions</h2>
              <p style={styles.subtitle}>Section B: Auto-close rules</p>
            </div>
            <div style={styles.content}>
        ...
        {step === 'escalation' && (
          <>
            <div style={styles.header}>
              <h2 style={styles.title}>Part 2: Review Instructions</h2>
              <p style={styles.subtitle}>Section C: Escalation triggers</p>
            </div>
            <div style={styles.content}>
              ...
              <QuestionInput label="Escalate if employee doesn't respond within ___ days?" id="escalateNoResponseDays" answers={answers} handleAnswer={handleAnswer} type="number" unit="days" />
        ...
        {step === 'documentation' && (
          <>
            <div style={styles.header}>
              <h2 style={styles.title}>Part 2: Review Instructions</h2>
              <p style={styles.subtitle}>Section D: Missing documentation</p>
            </div>
            <div style={styles.content}>
...
function QuestionInput({ label, id, answers, handleAnswer, type, unit, defaultValue }) {
  const styles = {
